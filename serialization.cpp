...
void Serializator::DeserializeCatalog(Catalogue &catalog,renderer::MapRenderer& renderer, router::TransportRouter& router)
{
    ...
    DeserializeBuses(catalog,proto_catalog);
...
void Serializator::DeserializeDistances(Catalogue &catalog, const proto_catalogue_serialization::TransportCatalogue &proto_catalog)
{
    const int size = proto_catalog.distance_between_stops_size();
...
void Serializator::DeserializeBuses(Catalogue &catalog,
...
{
    const int size = proto_catalog.stops_size();
